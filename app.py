...
# ---- Sidebar Controls ----
version = st.sidebar.selectbox("Select Version", ["Task 1", "Task 2 (ver1)", "Task 2 (ver2)", "Task 3 Pastel", "Task 3 Vivid", "Task 3 Monochrome"])
...
plt.text(0.05, 0.91, version, fontsize=11, transform=plt.gca().transAxes)
